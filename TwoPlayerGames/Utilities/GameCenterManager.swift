...
class GameCenterManager: ObservableObject {
    ...
    enum LeaderboardID: String, CaseIterable {
        ...
        case sonarDuelWins = "com.windsorsoft.TwoPlayerGames.sonarduel.wins"
        case dotsAndBoxesWins = "com.windsorsoft.TwoPlayerGames.dotsandboxes.wins"
        case warWins = "com.windsorsoft.TwoPlayerGames.war.wins"
    ...
    private func checkAchievements(totalWins: Int) {
        ...
        Task {
            ...
            // Try All Games
            let gameTypes: [GameType] = [.pingPong, .airHockey, .ticTacToe, .connectFour, .reactionTime, .simonSays, .tugOfWar, .memoryMatch, .colorConquest, .sonarDuel, .dotsAndBoxes, .war, .battleship, .wordChain, .mazeRace, .rhythmTap, .duelDraw]
...
extension GameCenterManager {
    enum GameType {
        ...
        case tugOfWar, memoryMatch, colorConquest, sonarDuel, dotsAndBoxes, war, battleship, wordChain, mazeRace, rhythmTap, duelDraw
        ...
        var leaderboardID: LeaderboardID {
            ...
            case .sonarDuel: return .sonarDuelWins
            case .dotsAndBoxes: return .dotsAndBoxesWins
            case .war: return .warWins
